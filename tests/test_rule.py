...
def test_totals_equal_total(example_ruleevaluator_equal):
    ...
    assert   list(example_ruleevaluator_equal.totals_df['nan']) == [1, 2, 1]
    # fmt: on
...
def test_totals_greater_total(example_ruleevaluator_greater):
    ...
    assert   list(example_ruleevaluator_greater.totals_df['nan']) == [1, 2, 1]
    # fmt: on
...
def test_totals_greater_equal_total(example_ruleevaluator_greater_equal):
    ...
    assert   list(example_ruleevaluator_greater_equal.totals_df['nan']) == [1, 2, 1]
    # fmt: on
...
def test_totals_smaller_total(example_ruleevaluator_smaller):
    ...
    assert   list(example_ruleevaluator_smaller.totals_df['nan']) == [1, 2, 1]
    # fmt: on
...
def test_totals_smaller_equal_total(example_ruleevaluator_smaller_equal):
    ...
    assert   list(example_ruleevaluator_smaller_equal.totals_df['nan']) == [1, 2, 1]
    # fmt: on
...
def test_totals_subset_total(example_ruleevaluator_subset):
    ...
    assert   list(example_ruleevaluator_subset.totals_df['nan']) == [1, 2, 2]
    # fmt: on
